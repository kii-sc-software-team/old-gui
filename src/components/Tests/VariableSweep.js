...
const TX_VARIABLES = [
    ...
    { id: 'mx_vga1', min: 1, max: 3, title: 'MX-VGA Stg 1' },
    { id: 'mx_vga2', min: 1, max: 3, title: 'MX-VGA Stg 2' },
    { id: 'txmx', min: 1, max: 3, title: 'TXMX' },
    { id: 'mx_pa', min: 1, max: 3, title: 'MX-PA' },
    { id: 'mx_da', min: 1, max: 3, title: 'MX-DA' },
    { id: 'pa', min: 1, max: 7, title: 'PA' },
    { id: 'da', min: 1, max: 7, title: 'DA' },
    { id: 'u_vga', min: 1, max: 7, title: 'Uni-VGA' },
    { id: 'u_vga_cs', min: 1, max: 15, title: 'Uni-VGA CS' },
...
const TX_IF3_VARIABLES = [    
    { id: 'tx_if1_ba', min: 1, max: 7, title: 'IF1 Bias' },
    { id: 'tx_if2_ba', min: 1, max: 7, title: 'IF2 Bias' },
    { id: 'tx_mx_ba', min: 1, max: 7, title: 'Mixer Bias' },
    { id: 'tx_act_balun_ba', min: 1, max: 7, title: 'Active Balun Bias'},
    { id: 'tx_div_ba', min: 1, max: 7, title: 'Divider Bias' },

    { id: 'tx_if1_gain', min: 0, max: 3, title: 'IF1 Gain' },
    { id: 'tx_if2_gain', min: 0, max: 1, title: 'IF2 Gain' },
    { id: 'tx_if_io_match', min: 1, max: 3, title: 'IO Matching' },
    { id: 'tx_if2_bsw', min: 0, max: 1, title: 'IF2 BSW'},
    { id: 'tx_poly_ul', min: 0, max: 1, title: 'Polyphase UL BSW' },
    { id: 'tx_poly_bsw', min: 1, max: 3, title: 'Polyphase Filter BSW' }
  ...
  const RX_IF3_VARIABLES = [

    { id: 'rx_if1_ba', min: 1, max: 7, title: 'IF1 Bias' },
    { id: 'rx_if2_ba', min: 1, max: 7, title: 'IF2 Bias' },
    { id: 'rx_mx_ba', min: 1, max: 7, title: 'Mixer Bias' },
    { id: 'rx_act_balun_ba', min: 1, max: 7, title: 'Active Balun Bias'},
    { id: 'rx_div_ba', min: 1, max: 7, title: 'Divider Bias' },
    { id: 'o_buff_ba', min: 1, max: 7, title: 'Output Buffer Bias' },

    { id: 'rx_if1_gain', min: 0, max: 3, title: 'IF1 Gain' },
    { id: 'rx_if2_gain', min: 0, max: 1, title: 'IF2 Gain' },
    { id: 'rx_attn', min: 0, max: 3, title: 'Attenuator' },
...
class VariableSweep extends React.Component {
    ...
    sweepVarsTX = e => {
        ...
        let if3_settings = {
            ...
            'if_lo_driver_ba': this.state.if_lo_driver_bias,
                    ...
                    {/* <Row> */}
                        ...
                        {/* <Col> */}
                            ...
                            <Form.Group>
                                ...
                                <Form.Group>
                                    <Form.Label>IF Mode</Form.Label>
                                    <ToggleButtonGroup type="radio" name="if_3_7">
                                        <ToggleButton variant="outline-dark" id="if3" value={"3"} checked={this.state.checked === "3"} onChange={this.handleInputChange}>
                                        3 GHz
                                        </ToggleButton>
                                        <ToggleButton variant="outline-dark" id="if7" value={"7"} checked={this.state.checked === "7"} onChange={this.handleInputChange}>
                                        7 GHz
                                        </ToggleButton>
                                    </ToggleButtonGroup>
                                </Form.Group>
